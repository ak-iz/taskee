defmodule TaskeeWeb.TaskLiveTest do
  use TaskeeWeb.ConnCase

  import Phoenix.LiveViewTest
  import Taskee.ProjectsFixtures

  @create_attrs %{description: "some description", due_date: "2023-06-04T12:07:00Z", is_completed: true, name: "some name"}
  @update_attrs %{description: "some updated description", due_date: "2023-06-05T12:07:00Z", is_completed: false, name: "some updated name"}
  @invalid_attrs %{description: nil, due_date: nil, is_completed: false, name: nil}

defmodule TaskeeWeb.ProjectLiveTest do
  use TaskeeWeb.ConnCase

  import Phoenix.LiveViewTest
  import Taskee.ProjectsFixtures

  @create_attrs %{description: "some description", due_date: "2023-06-04T12:04:00Z", name: "some name"}
  @update_attrs %{description: "some updated description", due_date: "2023-06-05T12:04:00Z", name: "some updated name"}

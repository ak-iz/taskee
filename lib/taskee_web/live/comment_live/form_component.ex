defmodule TaskeeWeb.CommentLive.FormComponent do
  ...
  def handle_event("validate", %{"comment" => comment_params}, socket) do
    changeset =
      ...
      |> Projects.change_comment(comment_params)
  ...
  defp save_comment(socket, :edit, comment_params) do
    case Projects.update_comment(socket.assigns.comment, comment_params) do
      {:ok, comment} ->
  ...
  defp save_comment(socket, :new, comment_params) do
    case Projects.create_comment(comment_params) do
      {:ok, comment} ->
        notify_parent({:saved, comment})
